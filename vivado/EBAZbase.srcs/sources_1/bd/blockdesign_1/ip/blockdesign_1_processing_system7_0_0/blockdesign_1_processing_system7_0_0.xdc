...
create_clock -name clk_fpga_2 -period "81.25" [get_pins "PS7_i/FCLKCLK[2]"]
set_input_jitter clk_fpga_2 2.4375
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_3 -period "6.25" [get_pins "PS7_i/FCLKCLK[3]"]
set_input_jitter clk_fpga_3 0.1875
#The clocks are asynchronous, user should constrain them appropriately.#
