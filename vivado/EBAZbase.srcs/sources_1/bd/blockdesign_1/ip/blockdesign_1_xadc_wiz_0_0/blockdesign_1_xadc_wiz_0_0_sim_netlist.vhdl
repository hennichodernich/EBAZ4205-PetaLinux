...
--               /home/henning/vivado20/EBAZbase/EBAZbase.srcs/sources_1/bd/blockdesign_1/ip/blockdesign_1_xadc_wiz_0_0/blockdesign_1_xadc_wiz_0_0_sim_netlist.vhdl
...
entity blockdesign_1_xadc_wiz_0_0_drp_to_axi4stream is
  port (
  ...
  attribute ORIG_REF_NAME of blockdesign_1_xadc_wiz_0_0_drp_to_axi4stream : entity is "drp_to_axi4stream";
end blockdesign_1_xadc_wiz_0_0_drp_to_axi4stream;

architecture STRUCTURE of blockdesign_1_xadc_wiz_0_0_drp_to_axi4stream is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_xadc_core_drp is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 15 downto 0 );
    m_axis_tid : out STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_xadc_core_drp : entity is "blockdesign_1_xadc_wiz_0_0_xadc_core_drp";
end blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_xadc_core_drp;

architecture STRUCTURE of blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_xadc_core_drp is
...
drp_to_axi4stream_inst: entity work.blockdesign_1_xadc_wiz_0_0_drp_to_axi4stream
     port map (
      AR(0) => m_axis_reset,
      CHANNEL(4 downto 0) => \^channel_out\(4 downto 0),
      DO(15 downto 0) => do_C(15 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_axi_xadc is
  port (
    s_axis_aclk : in STD_LOGIC;
    m_axis_aclk : in STD_LOGIC;
    m_axis_resetn : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_axi_xadc : entity is "blockdesign_1_xadc_wiz_0_0_axi_xadc";
end blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_axi_xadc;

architecture STRUCTURE of blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_axi_xadc is
...
begin
  ...
  alarm_out(1) <= \<const0>\;
  alarm_out(0) <= \<const0>\;
AXI_XADC_CORE_I: entity work.blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_xadc_core_drp
     port map (
...
entity blockdesign_1_xadc_wiz_0_0 is
  ...
  attribute NotValidForBitStream of blockdesign_1_xadc_wiz_0_0 : entity is true;
end blockdesign_1_xadc_wiz_0_0;

architecture STRUCTURE of blockdesign_1_xadc_wiz_0_0 is
  signal NLW_U0_alarm_out_UNCONNECTED : STD_LOGIC_VECTOR ( 6 downto 0 );
begin
U0: entity work.blockdesign_1_xadc_wiz_0_0_blockdesign_1_xadc_wiz_0_0_axi_xadc
     port map (
