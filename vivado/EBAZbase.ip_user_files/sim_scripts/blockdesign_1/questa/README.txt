...
#
# Generated by export_simulation on Mon Apr 24 23:13:12 CEST 2023
#
################################################################################
...
'-reset_run' switch to the './blockdesign_1.sh' script.

./blockdesign_1.sh -reset_run
...
./blockdesign_1.sh -noclean_files

For more information on the script, please type './blockdesign_1.sh -help'.
